...
bool ModuleAsiaStage::Start() {
	...
	for (int i = 0; i < 5000; ++i) {
		...
		if (i > 1050 && i < 1250) rp->curvefactor = -2;
		if (i > 2000 && i < 2200) rp->curvefactor = -2;
		if (i > 2400 && i < 2600) rp->curvefactor = 3;
		if (i > 3800 && i < 4000) rp->curvefactor = -3;
		if (i > 4050 && i < 4250) rp->curvefactor = 3;
		// Hills
		if (i > 0) {
			if (i >= 720 && i <= 970) {
				if (i == 721) {
			...
			else if (i >= 1400 && i <= 1550) {
				if (i == 1401) {
					float cos1 = cos(1400.0f / 30.0f) * 1000.0f;
					float cos2 = cos(1399.0f / 30.0f) * 1000.0f;
				...
				if (i == 3001) {
					float cos1 = cos(3000.0f / 30.0f) * 1000.0f;
					float cos2 = cos(2999.0f / 30.0f) * 1000.0f;
